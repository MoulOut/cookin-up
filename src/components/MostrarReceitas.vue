...
<template>
  <section class="mostrar-receitas">
    ...
    <p class="paragrafo-lg resultados-encontrados">
      Resultados encontrados: {{ receitasPossiveis.length }}
    </p>

    <div v-if="receitasPossiveis.length" class="receitas-wrapper">
      ...
      <ul class="receitas">
        <li v-for="receita of receitasPossiveis" :key="receita.nome">
